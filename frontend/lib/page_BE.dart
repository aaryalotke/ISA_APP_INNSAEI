...
class page_BE extends StatefulWidget {
   final List<Council> BE;
     page_BE(this.BE);
     
   
 
  @override
  State<page_BE> createState() => _page_BEState();
}
 
class _page_BEState extends State<page_BE> {
                      ...
                      Positioned(
                        child: Container(
                            child: ClipRRect(
                              ...
                              child: Image.network(widget.BE[index].photo!,
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Material(
                                      ...
                                      child: IconButton(
                                        onPressed: (){launchurlmail(widget.BE[index].email!);},
                                        icon: Icon(
                                          Icons.mail_rounded,
                                          color: Colors.black,
                                          size: 60,
                                  ...
                                  Container(
                                    ...
                                    child:Material(
                                      ...
                                      highlightColor: Colors.black26,
                                      child:  IconButton(
                                      onPressed: (){launchurlinsta(widget.BE[index].insta_id!);},
                                      icon: Icon(
                                  ...
                                  Container(
                                   ...
                                   // padding: EdgeInsets.all(0.0),
                                     ...
                                     child: IconButton(
                                      onPressed: (){launchurlinlink(widget.BE[index].linked_in!);},
                                      icon :Icon(
