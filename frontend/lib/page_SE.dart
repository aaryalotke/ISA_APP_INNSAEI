                      ...
                      Positioned(
                        child: Container(
                            child: ClipRRect(
                              ...
                              child: Image.network(widget.SE[index].photo!,
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    //padding: EdgeInsets.all(5.0),
                                      ...
                                      child: IconButton(
                                        onPressed: (){launchurlmail(widget.SE[index].email!);},
                                        icon: Icon(
                                          Icons.mail_rounded,
                                          color: Colors.black,
                                          size: 60,
                                  ...
                                  Container(
                                    ...
                                    //padding: EdgeInsets.all(5.0),
                                      ...
                                      // highlightColor: Colors.black26,
                                      child:  IconButton(
                                      onPressed: (){launchurlinsta(widget.SE[index].insta_id!);},
                                      icon: Icon(
                                  ...
                                  Container(
                                    ...
                                    //padding: EdgeInsets.all(5.0),
                                     ...
                                     child: IconButton(
                                      onPressed: (){launchurlinlink(widget.SE[index].linked_in!);},
                                      icon :Icon(
