...
class page_FACULTY extends StatefulWidget {
  final List<Council> FACULTY;
     page_FACULTY(this.FACULTY);

  @override
  State<page_FACULTY> createState() => _page_FACULTYState();
}

class _page_FACULTYState extends State<page_FACULTY> {
                      ...
                      Positioned(
                        child: Container(
                            child: ClipRRect(
                              ...
                              child: Image.network(widget.FACULTY[index].photo!,
                               alignment: FractionalOffset.topCenter,
                              fit: BoxFit.cover,
                                //image:Image.network( widget.FACULTY[index].photo!),
                                //fit: BoxFit.cover,
                              //alignment: FractionalOffset.topCenter,
                                ),
                              ),
                         ...
                         margin: const EdgeInsets.fromLTRB(0, 0, 188, 225),
                          ...
                          margin: const EdgeInsets.fromLTRB(0, 0, 225, 225),
                            padding: EdgeInsets.fromLTRB(0, 10, 100, 0),
                             child: IconButton(
                              ...
                              Container(
                                    height: 200,
                                    width: 300,
                                    margin: EdgeInsets.only(top: 65.0, left: 20.0, right: 0.0, bottom: 0.0),
                                    // padding: EdgeInsets.fromLTRB(57, 10, 10, 0),
                                    child: Text(
                                      widget.FACULTY[index].post!,
                                      textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Voces',fontSize: 32,color: Colors.white),
                                    ),
                                  ),
                            ...
                            Container(
                                    height: 70,
                                    width: 70,
                                    margin: EdgeInsets.only(top: 120.0, left: 20.0, right: 0.0, bottom: 0.0),
                                    // padding: EdgeInsets.fromLTRB(57, 10, 10, 0),
                                    child: Text("Social", textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Voces',fontSize: 25,color: Colors.black),),
                                  ),
                            ...
                            Container(
                                ...
                                children: <Widget>[
                                  Container(
                                    margin: EdgeInsets.only(top: 205.0, left: 40.0, right: 0.0, bottom: 5.0),
                                    ...
                                    child: Material(
                                      ...
                                      child: IconButton(
                                        onPressed: (){launchurlmail(widget.FACULTY[index].email!);},
                                        icon: Icon(
                                          Icons.mail_rounded,
                                          color: Colors.black,
                                          size: 60,
                                  ...
                                  Container(
                                    margin: EdgeInsets.only(top: 200.0, left: 0.0, right: 0.0, bottom: .0),
                                    ...
                                    child:Material(
                                      ...
                                      highlightColor: Colors.black26,
                                      child:  IconButton(
                                      onPressed: (){launchurlinsta(widget.FACULTY[index].insta_id!);},
                                      icon: Icon(
                                  ...
                                  Container(
                                    margin: EdgeInsets.only(top: 200.0, left: 0.0, right: 40.0, bottom: 0.0),
                                   // padding: EdgeInsets.all(0.0),
                                     child:Material(
                                      color: Colors.transparent,
                                      child: InkWell(
                                     ...
                                     child: IconButton(
                                      onPressed: (){launchurlinlink(widget.FACULTY[index].linked_in!);},
                                      icon :Icon(
