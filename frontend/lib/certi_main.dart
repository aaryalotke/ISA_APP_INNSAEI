...
class _certi_pageState extends State<certi_page> with SingleTickerProviderStateMixin {
   late TabController controller;

   final List<format_certi> certi = [   //all 9 people's detail
    format_certi(
      id: '1',
      name: 'a',
      link: 'https://drive.google.com/drive/u/0/folders/128FEZZDy_NjK2iaWkGYgyRHY9DlW8MoU'   ,
    ...
    format_certi(
      ...
      link: 'https://drive.google.com/file/d/17xacvh1sDsK6De656zmQmmldYpvOX7AE/view?usp=sharing'   ,
