...
class _HomeScreenState extends State<HomeScreen> {
        ...
        Positioned(
             ...
             top: MediaQuery.of(context).size.height * 0.61,
              child: Container(
                width: MediaQuery.of(context).size.width,
                       padding: const EdgeInsets.fromLTRB(20, 5, 20, 0),
              child: Text('Analog Electronics Workshop',
              style: TextStyle(
                fontFamily: 'Voces',
              fontSize: 16,
              color: Colors.black),
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(
                         ...
                         onPressed: (){},
                            child: Text('ENQUIRE           ',style: TextStyle(color: Colors.white,fontSize: 14),),
 ...
 Positioned(
    ...
    AssetImage assetImage = AssetImage('assets/images/AnalogElectronicsPoster.jpg');
