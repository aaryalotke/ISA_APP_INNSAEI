...
class gallerySecond extends StatefulWidget {
  final List<gallery> software;
   final String access;
  const gallerySecond(this.software, this.access, {Key? key}) : super(key: key); //Image List for hardware has been recieved
...
class _gallerySecondState extends State<gallerySecond> {
 ...
 //new Image.network("${widget.software[index].poster2}
                 child: widget.software[index].poster2=="" ? const SizedBox(height: 0,width: 0,) : Container(child: Column(children:<Widget>[
