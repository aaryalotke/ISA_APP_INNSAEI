...
class galleryClick extends StatefulWidget {
  ...
  const galleryClick( this.access,this.image_id, this.image_name, this.image_pic1, this.image_pic2, this.image_pic3, this.image_startdate, this.image_enddate, this.image_description, {Key? key}) : super(key: key); //Recieved image id
