...
class page_FACULTY extends StatefulWidget {
  ...
  const page_FACULTY(this.FACULTY, {Key? key}) : super(key: key);
                      ...
                      front:
                        ...
                        Positioned(
                          child: Container(
                            ...
                            padding: const EdgeInsets.fromLTRB(57, 10, 10, 0),
                            height: 300,
                            width: 300,
                      ...
                      front:
                        ...
                        Positioned(
                          child: Container(
                            ...
                            padding: const EdgeInsets.fromLTRB(24, 10, 10, 0),
                            child: Text(
                              widget.FACULTY[index].name!,
                              textAlign: TextAlign.center,
                              style: const TextStyle(
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: IconButton(
                                        onPressed: () {
                                          launchurlinlink(
                                              widget.FACULTY[index].linked_in!);
                                        },
                                        icon: const Icon(
                                          FontAwesomeIcons.linkedin,
                                          color: Colors.black,
