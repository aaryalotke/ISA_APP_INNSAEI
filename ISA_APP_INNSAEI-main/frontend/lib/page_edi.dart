...
class page_edi extends StatefulWidget {
  ...
  const page_edi(this.editorial, {Key? key}) : super(key: key);
    ...
    return SizedBox(
      ...
      height: MediaQuery.of(context).size.height,
       ...
       // margin: EdgeInsets.fromLTRB(0, 100, 0, 0),
                              ...
                              children: <Widget>[
                                Container(
                                  margin: const EdgeInsets.fromLTRB(15, 0, 15, 25),
                                    child: Center(
                                      child: Text(
                                widget.editorial[0].editorial_name!,
                                textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Voces',fontSize: 17,color: Colors.white),),
                                    ),
                                ),
        ...
        backgroundColor: const Color.fromARGB(255, 234, 160, 147),
         minimumSize: const Size(52, 15),
          // maximumSize: const Size(52, 15),
    ),
   onPressed: (){launchurledi(widget.editorial[0].editorial_link!);},
                          ...
                          child: Stack(
                              ...
                              children: <Widget>[
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                widget.editorial[1].editorial_name!,
                                textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Voces',fontSize: 17,color: Colors.white),),
                                    ),
                                ),
    ...
    onPressed: (){launchurledi(widget.editorial[1].editorial_link!);},
    child:  const Text('Read',
          textAlign: TextAlign.center,
           style: TextStyle(
                                fontFamily: 'Ubuntu',
                              ...
                              children: <Widget>[
                                Container(
                                  margin: const EdgeInsets.fromLTRB(15, 0, 15, 25),
                                    child: Center(
                                      child: Text(
                                widget.editorial[2].editorial_name!,
                                textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Voces',fontSize: 17,color: Colors.white),),
                                    ),
                                ),
    ...
    onPressed: (){launchurledi(widget.editorial[2].editorial_link!);},
    child:  const Text('Read',
          textAlign: TextAlign.center,
           style: TextStyle(
                                fontFamily: 'Ubuntu',
                              ...
                              children: <Widget>[
                                Container(
                                  margin: const EdgeInsets.fromLTRB(15, 0, 15, 25),
                                    child: Center(
                                      child: Text(
                                widget.editorial[3].editorial_name!,
                                textAlign: TextAlign.center, style: const TextStyle(fontFamily: 'Voces',fontSize: 17,color: Colors.white),),
                                    ),
                                ),
    ...
    onPressed: (){launchurledi(widget.editorial[3].editorial_link!);},
    child:  const Text('Read',
          textAlign: TextAlign.center,
           style: TextStyle(
                                fontFamily: 'Ubuntu',
                          ...
                          child: Stack(
                            ...
                            child: Center(
                             child: ElevatedButton(
          style: ElevatedButton.styleFrom(
         backgroundColor: const Color.fromARGB(255, 79, 78, 104),
         minimumSize: const Size(52, 15),
          // maximumSize: const Size(52, 15),
    ),
