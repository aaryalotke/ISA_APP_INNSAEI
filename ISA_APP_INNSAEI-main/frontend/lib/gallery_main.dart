...
class gallery_main extends StatefulWidget {
  final String access;
  const gallery_main(this.access, {Key? key}) : super(key: key);
  @override
              ...
              ? TabBarView(
                  children: [
                    Container(
                        ...
                        child: galleryFirst(hardware, widget.access)
                        //galleryFirst ko call kiya with images as arguments

                        ),
                    Container(
                        padding: const EdgeInsets.all(20),
                        child: gallerySecond(software, widget.access)
                        //gallerySecond ko call kiya with images as arguments

                        ),
                    Container(
                        padding: const EdgeInsets.all(20),
                        child: galleryThird(others, widget.access)
