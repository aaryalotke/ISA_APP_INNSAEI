...
class pageone_dev extends StatefulWidget {
  ...
  const pageone_dev(this.people, {Key? key}) : super(key: key); //Image List for hardware has been recieved
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        child: Container(
                          ...
                          padding: const EdgeInsets.fromLTRB(110, 10, 0, 5),
                          decoration: ShapeDecoration(
                            color: const Color(0xFFFE735D).withOpacity(0.8),
                            //color: Color(0xFFFE735D),
                            shape: RoundedRectangleBorder(
                    ...
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          padding: const EdgeInsets.fromLTRB(0, 10, 48, 0),
                          child: Text(
                            widget.people[index].name!,
                            textAlign: TextAlign.center,
                            style: const TextStyle(
                      ...
                      Positioned(
                        child: Container(
                          ...
                          padding: const EdgeInsets.fromLTRB(0, 10, 105, 5),
                          decoration: ShapeDecoration(
                            color: const Color(0xFF00467F).withOpacity(0.8),
                            //color: Color(0xFF00467F),
                            shape: RoundedRectangleBorder(
